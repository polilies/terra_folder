...
locals {
  github-email    = "alijan84@hotmail.com"     # you need to change this line
  github-username = "polilies"                # you need to change this line
  github-token    = "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"                # you need to change this line
  key_pair        = "nvirginia"                   # you need to change this line
  pem_key_address = "~/.ssh/nvirginia.pem"        # you need to change this line
